...
Deep Agents use their filesystem to store and retrieve information. How long that information is available for depends on which [backend](/oss/python/deepagents/backends) you configure.
