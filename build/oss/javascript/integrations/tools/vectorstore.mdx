...
This will help you getting started with `VectorStoreToolkit` [toolkits](/oss/javascript/langchain/tools#toolkits). For detailed documentation of all `VectorStoreToolkit` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain.agents.VectorStoreToolkit.html).
