...
1. In the **Experiments** view, hover over experiments to find the **Set baseline** button. Click to select your baseline experiment.
...
LangSmith lets you download experiment results as a CSV file for external analysis and sharing. Click the **Download as CSV** at the top right of the experiment view.
